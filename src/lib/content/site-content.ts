...
const sharedCourtSpecs = {
	...
	tennis: {
		description:
			"Теннисный корт подходит для индивидуальных тренировок, парной игры и матчевой практики.",
...
export const homePageContent = {
	hero: {
		eyebrow: "Центр ракеточных видов спорта - г. Тобыл",
		title: "Теннис, падел и сквош в Костанае",
		description:
			"Первый центр в республике, объединяющий корты для тенниса, падела и сквоша. Онлайн-запись, тренеры и комфортные условия для всех уровней игры.",
	},
	primaryActionLabel: "Онлайн запись",
	pricingTitle: "Цены на наши услуги",
	pricingSubtitle:
		"Актуальные цены на аренду кортов и занятия с тренером. Для тренировок итоговая сумма будет зависить от выбранного тренера.",
	equipmentBanner:
		"Мячи для сквоша и базовые ракетки включены в стоимость занятия. Если нужна продвинутая ракетка или помощь с первым визитом - обращайтесь к администратору.",
	faqTitle: "FAQ",
...
export const coachesPageContent = {
	hero: {
		eyebrow: "Тренеры",
		title: "Тренеры по теннису, паделу и сквошу",
		description:
