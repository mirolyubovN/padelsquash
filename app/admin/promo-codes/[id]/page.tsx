...
export function generateMetadata() {
  return buildPageMetadata({
    title: "Промокод | Padel & Squash KZ",
              ...
              <form action={updateAction} className="admin-form">
                <div className="admin-form__panel-grid">
                  ...
                  <div className="admin-form__group">
                    ...
                    <input id="detail-validFrom" name="validFrom" type="date" className="admin-form__field" defaultValue={promo.validFrom ?? ""} />
                  </div>
                  <div className="admin-form__group">
                    <label className="admin-form__label" htmlFor="detail-validUntil">{t("admin.promoCodes.fields.validUntil")}</label>
                    <input id="detail-validUntil" name="validUntil" type="date" className="admin-form__field" defaultValue={promo.validUntil ?? ""} />
                  </div>
                  <div className="admin-form__group">
