...
export const metadata = buildPageMetadata({
	title: "Админ: события | Racket Community Kst",
				...
				<form action={createAction} className="admin-form admin-form--panel">
					...
					<div className="admin-form__panel-grid">
						...
						<div className="admin-form__group">
							...
							<input id="event-date" name="date" type="date" lang="ru-RU" className="admin-form__field" defaultValue={today} required />
						</div>
						<div className="admin-form__group">
							<label className="admin-form__label" htmlFor="event-start-time">{t("admin.events.fields.startTime")}</label>
							<input id="event-start-time" name="startTime" type="time" lang="ru-RU" step="900" className="admin-form__field" defaultValue="19:00" required />
						</div>
						<div className="admin-form__group">
												...
												<form action={updateAction} className="admin-form">
													...
													<div className="admin-form__panel-grid">
														...
														<div className="admin-form__group">
															...
															<input id={`event-date-${event.id}`} name="date" type="date" lang="ru-RU" className="admin-form__field" defaultValue={toVenueIsoDate(event.startsAt)} required />
														</div>
														<div className="admin-form__group">
															<label className="admin-form__label" htmlFor={`event-time-${event.id}`}>{t("admin.events.fields.startTime")}</label>
															<input id={`event-time-${event.id}`} name="startTime" type="time" lang="ru-RU" step="900" className="admin-form__field" defaultValue={formatTimeInVenueTimezone(event.startsAt)} required />
														</div>
														<div className="admin-form__group">
