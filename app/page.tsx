      ...
      <div className="home">
        ...
        <section className="home__hero" aria-labelledby="home-hero-title">
          <div className="home__container home__hero-grid">
            <div className="home__hero-copy" data-reveal>
              <p className="home__eyebrow">{homePageContent.hero.eyebrow}</p>
              ...
              <div className="home__hero-actions">
                ...
                <Link href="/prices" className="home__btn home__btn--ghost">
                  Посмотреть цены
                </Link>
              </div>
            ...
            <div className="home__hero-figure" data-reveal data-delay="2" aria-hidden="true">
              <img
                src="https://picsum.photos/seed/club-courts-warm/1100/1300"
                alt=""
                loading="eager"
              />
              <span className="home__hero-figure-tag">{siteConfig.city}</span>
            </div>
          </div>
        </section>
