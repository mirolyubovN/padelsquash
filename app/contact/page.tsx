...
export const metadata = buildPageMetadata({
	title: "Контакты | Racket Community Kst",
	description: "Адрес, телефон, часы работы и как добраться до клуба падела и сквоша в Костанай. Ссылки на WhatsApp, Telegram и Instagram.",
	path: "/contact",
});
