...
export const metadata = buildPageMetadata({
	title: "События | Racket Community Kst",
...
export default async function EventsPage({
	...
	return (
		<div className="events-page">
			<PageHero
				eyebrow="События"
				title="Клубные дни, групповые тренировки и другие мероприятия"
				description="Выбирайте формат занятия, который подходит вам и записывайтесь онлайн."
			/>
