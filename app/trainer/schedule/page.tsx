...
export const metadata = buildPageMetadata({
	title: "Кабинет тренера: расписание | Racket Community Kst",
							...
							<tbody>
								<tr className="admin-table__row">
									<td className="admin-table__cell">
										...
										<input id="trainer-exception-date" name="date" type="date" lang="ru-RU" className="admin-form__field" required />
									</td>
									<td className="admin-table__cell">
